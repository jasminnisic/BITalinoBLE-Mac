...
# How to import SDK
 1. Create new Xcode project (Cocoa application) and add BITalinoBLEMac.framework file to it. If you are adding it using drag and drop option, make sure that **Copy items if needed** is checked. 
 ...
 5. Expand **Copy files** phase and drag BITalinoBLEMac.framework to this section
 6. Change **Destination** to **Frameworks**

BITalinoBLE SDK is now added to your project and you can use it.

![enter image description here](http://i.imgur.com/CmuGXMt.png)

# BITalinoBLE SDK for Mac
...
# BITalinoBLEMac-Example Cocoa App
It is pre-configured ready-to-use example app covering all the functionalities from the BITalinoBLEMac.framework.
![enter image description here](http://i.imgur.com/iukj4Uk.png)